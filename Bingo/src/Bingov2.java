...
public class Bingov2 {
    ...
    public static void rellenarCarton(int jugador1[][], int numsBingo, int bingo[]) {
    ...
    public static boolean compararBingo(int suma[], boolean hayBingo, boolean esIA, int IA[][]) {
        int sumaBingo = 0;
    ...
    public static void main(String[] args) {
        ...
        while (hayBingo == false) {
            ...
            hayBingo = compararBingo(sumaJugador, hayBingo, false, jugador1);
            hayBingo = compararBingo(sumaIA, hayBingo, true, IA);
